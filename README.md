...
11. For now, only the registration, login, logout and view profile, reservation, edit reservation, view reservations is implemented. Other features will be implemented soon.
